...
class EducationInfoCollectionViewCell: UICollectionViewCell {
    ...
    @objc fileprivate func tapForInfoAboutTrainer() {
        ...
        UIView.transition(from: self.educationInfoContainerView, to: self.trainerInfoContainerView, duration: 0.5, options: [UIView.AnimationOptions.transitionFlipFromLeft, .layoutSubviews], completion: {(_) in
            self.fillCellData()
        })
    }
    ...
    @objc fileprivate func tapForInfoAboutEducation() {
        ...
        UIView.transition(from: self.trainerInfoContainerView, to: self.educationInfoContainerView, duration: 0.5, options: [.transitionFlipFromRight, .layoutSubviews], completion: {(_) in
            self.fillCellData()
        })
    }
